    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card shadow="hover" class="mgb20">
          <div class="tools">
            <a href="./file/ETL导入格式模板.xlsx"><el-button size="medium" type="text">下载导入模板</el-button></a>
            <el-upload
              class="upload"
              action="demo"
              ...
              :http-request="upload"
            >
              <el-button  type="primary">ETL数据导入</el-button>
            </el-upload>
          </div>
          <el-table
            :data="table_data"
  ...
  methods: {
    getData() {
      if(this.handleStatus.length){
        this.$axios({
          url: "/etlConfig/queryEtlConfigFile",
          method: "POST",
          data: {
