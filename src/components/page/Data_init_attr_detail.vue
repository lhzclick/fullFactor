      ...
      <el-col :span="24">
        <el-card shadow="hover" class="mgb20">
          <el-breadcrumb class="breadcrumb" separator="/">
            <el-breadcrumb-item :to="{ path: '/data_init_attr' }">属性定义表导入</el-breadcrumb-item>
            <el-breadcrumb-item>属性定义表导入详情</el-breadcrumb-item>
          </el-breadcrumb>
          <div class="time">
...
export default {
  ...
  methods: {
    getData() {
      this.$axios({
          url: "/attrDesc/queryAttrDescFileError",
          method: "POST",
          data: {
